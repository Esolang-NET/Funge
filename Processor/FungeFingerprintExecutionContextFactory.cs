...
record FungeFingerprintExecutionContextFactory(IFungeExecutionContext ExecutionContext, IFungeInstructionPointerContext InstructionPointerContext, IFungeStackContext StackContext, IFungeVectorContext VectorContext, IFungeSpaceContext SpaceContext, IFungeStorageOffsetContext StorageOffsetContext, IFungeRandomContext RandomContext, bool DisabledOutput = false, bool DisabledInput = false)
{
    /// <summary>
    /// Initializes a new instance of the <see cref="FungeFingerprintExecutionContextFactory"/> class with the specified instruction pointer, space, random source, and optional output/input settings.
    /// </summary>
    /// <param name="ip"></param>
    ...
    /// <param name="disabledOutput"></param>
    /// <param name="disabledInput"></param>
    public FungeFingerprintExecutionContextFactory(InstructionPointer ip, FungeSpace space, FungeRandomSource random, bool disabledOutput = false, bool disabledInput = false) : this(ip, ip, ip, ip, new FungeStackContext(space), ip, random, disabledOutput, disabledInput) { }
