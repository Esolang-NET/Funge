...
/// </summary>
public sealed class DoublePrecisionFloatFingerprint(string? name = null) : IFingerprint
{
    /// <summary>
    /// Gets the default name of the fingerprint, which is <c>"FPDP"</c>.
    /// </summary>
    public const string NAME = "FPDP";
